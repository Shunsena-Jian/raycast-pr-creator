...
export function ReviewerManagementView({ onSelectRepo }: { onSelectRepo: (repoPath: string) => Promise<void> }) {
...
function ReviewerManagementLoader({ selectedRepoPath }: { selectedRepoPath: string }) {
